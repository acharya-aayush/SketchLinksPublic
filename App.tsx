       ...
       {!isConnected ? (
           ...
           <div className="relative z-10 flex flex-col h-full">
               ...
               <div className="flex flex-col h-full">
                   ...
                   {/* Canvas Area - takes most of the screen with flexible height */}
                   <div className="relative flex items-center justify-center flex-1 min-h-0 p-2 overflow-hidden">
                       {/* Canvas wrapper - uses container query for proper sizing */}
                       <div 
                         className={`relative w-full h-full flex items-center justify-center`}
                       >
                         <div 
                           className={`relative bg-white border-2 shadow-lg rounded-xl overflow-hidden ${messiMode ? 'border-yellow-400 ring-4 ring-yellow-300/50 animate-glow' : 'border-slate-200'}`}
                           style={{ 
                             aspectRatio: '16/9',
                             maxWidth: '100%',
                             maxHeight: '100%',
                   ...
                   {/* Bottom Panel: Leaderboard + Chat side by side - adaptive height */}
                   <div className="flex flex-row border-t border-slate-200 shrink-0" style={{ height: 'clamp(120px, 25vh, 180px)' }}>
                       {/* Compact Leaderboard */}
                       <div className="w-2/5 border-r border-slate-200 overflow-hidden">
                           <PlayerList 
                             players={players} 
                             drawerId={drawerId} 
                             onLeave={handleLeave} 
                   ...
                   {/* Guess Input - Fixed at bottom with safe area */}
               ...
               <div className="flex flex-row h-full">
                   ...
                   <main className="relative flex flex-col flex-1 min-w-0 bg-slate-200">
                       <div className="relative flex flex-col flex-1 min-h-0 p-4">
                            ...
                            {/* Desktop canvas wrapper - centers canvas with proper aspect ratio */}
                            <div className="relative flex items-center justify-center w-full h-full">
                              <div 
                                className={`relative bg-white border-4 shadow-lg wobbly-border overflow-hidden ${messiMode ? 'border-yellow-400 ring-4 ring-yellow-300/50 animate-glow' : 'border-slate-300'}`} 
                                style={{ 
                                  aspectRatio: '16/9',
                                  maxWidth: '100%',
                                  maxHeight: '100%',
