...
// fixed resolution so strokes would look the same on all screens (IDK but iphone se rw m31 maa does work)
...
export const CanvasBoard = forwardRef<CanvasBoardHandle, CanvasBoardProps>(({ 
  ...
  // converts screen pos to canvas pos (took a while to get right)
